...
import type { AgentMessage, MessageRenderer } from "@prajwal/jarvis-web-ui";
import { defaultConvertToLlm, registerMessageRenderer } from "@prajwal/jarvis-web-ui";
...
declare module "@prajwal/jarvis-agent" {
