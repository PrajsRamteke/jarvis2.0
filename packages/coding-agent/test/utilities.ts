...
import { Agent } from "@prajwal/jarvis-agent";
import { getModel, type OAuthCredentials, type OAuthProvider } from "@prajwal/jarvis-ai";
import { getOAuthApiKey } from "@prajwal/jarvis-ai/oauth";
...
// ============================================================================
// OAuth API key resolution from ~/.jarvis/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".jarvis", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.jarvis/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.jarvis/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".jarvis", "agent");

/**
 * Get an AuthStorage instance backed by ~/.jarvis/agent/auth.json
