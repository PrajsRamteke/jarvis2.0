...
import type { AssistantMessage, Model } from "@prajwal/jarvis-ai";
...
vi.mock("@prajwal/jarvis-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@prajwal/jarvis-ai")>();
	return {
		...actual,
