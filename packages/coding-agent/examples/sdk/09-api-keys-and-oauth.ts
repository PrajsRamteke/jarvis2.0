...
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@prajwal/jarvis-coding-agent";

// Default: AuthStorage uses ~/.jarvis/agent/auth.json
// ModelRegistry loads built-in + custom models from ~/.jarvis/agent/models.json
