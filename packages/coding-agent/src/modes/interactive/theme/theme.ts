...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@prajwal/jarvis-tui";
...
const THEME_KEY = Symbol.for("@prajwal/jarvis-coding-agent:theme");
...
export function getSettingsListTheme(): import("@prajwal/jarvis-tui").SettingsListTheme {
	return {
