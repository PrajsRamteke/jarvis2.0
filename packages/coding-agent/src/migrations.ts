...
/**
 * Migrate sessions from ~/.jarvis/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.jarvis/agent/ instead of
 * ~/.jarvis/agent/sessions/<encoded-cwd>/. This migration moves them
