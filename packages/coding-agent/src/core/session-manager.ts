 ...
 * Encodes cwd into a safe directory name under ~/.jarvis/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.jarvis/agent/sessions/<encoded-cwd>/).
	 */
